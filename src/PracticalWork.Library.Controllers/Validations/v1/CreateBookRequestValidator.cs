...
{
    /// <summary>
    /// Валидатор запроса на создание книги.
    /// Проверяет корректность названия, категории, авторов,
    /// описания и года издания.
    /// </summary>
    public sealed class CreateBookRequestValidator : AbstractValidator<CreateBookRequest>
    {
        /// <summary>
        /// Создаёт новый экземпляр валидатора для <see cref="CreateBookRequest"/>.
        /// </summary>
        public CreateBookRequestValidator()
        {
            ...
            RuleFor(x => x.Category)
                .IsInEnum().WithMessage("Категория должна быть корректным значением перечисления.");
            ...
            RuleFor(x => x.Year)
                ...
                .WithMessage("Год издания должен быть между 1800 и текущим годом.");
        }
    }
}
